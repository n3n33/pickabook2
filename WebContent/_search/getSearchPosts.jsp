...
<%
	...
	postLists = postPro.getPostListSearch(query, start, end);
	int total_count = postPro.getPostSearchCount(query);
%>
...
<div class="innerSize">
	...
	<div class="ui text menu" style="margin-top: 0; margin-bottom: 1em;">
		<div class="header item">
			포 스 트 (<span style="color: #B70A15;"><%=total_count%></span>)
		</div>
	</div>
	
	<!-- 하단 내용 -->
    <div class="ui items">
       <div class="ui middle aligned divided list search-post-item-parent">
          <%
             if (postLists.size() == 0) {
          %>
             <div class="ui centered grid">                     
                <p><div class="ui tiny header"><%=query%>에 해당하는 포스트가 없습니다.</div>                                 
             </div>
          <%
             } else {
          ...
          <div class="item search-post-item">
            	...
            	<div class="ui centered grid">
            		...
            		<div class="sixteen wide column" style="margin-bottom: -1em;">
         			...
         			<div class="eight wide column" style="height: 150px; margin-right: 0.7em; overflow: hidden;">
         				<p class="post-content search-post-content"><%=postList.getContent()%></p>	                				
         			</div>        
         			...
         			<div class="five wide column" style="height: 150px; margin-bottom: 1em;">
         				...
         				<div style="margin-bottom: 0.7em; margin-left: 1em;">
         					<a class="search-post-book-title" style="font-size: 16px; font-weight: 600;" href="/pickabook/_browse/bookInfo.jsp?isbn=<%= postList.getIsbn() %>">
         				...
         				<!-- 별점 -->
         				<div style="margin-bottom: 0.7em; margin-left: 1em;">
          					<div class="ui star rating search-post-star" data-rating="<%=postList.getStar_rate()%>" data-max-rating="5"></div>
         				</div>				
						<!-- 좋아요 수, 댓글 수 -->
...
<div class="ui basic segment search-post-end" style="margin-top: 1em; text-align: center;">
<%
   	if(start == 0 && total_count > end || start + end < total_count){
		...
		<a href="" class="search-post-more gray-font">
			포스트 <%=remain_posts %>개 더보기
			<div class="ui inline mini loader search-post-more-loader"></div>
		</a>	
<%	}
	else{%>
